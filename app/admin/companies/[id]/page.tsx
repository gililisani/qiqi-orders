    ...
    const fetchCompany = async () => {
      try {
        ...
        const combinedData = {
          ...
          target_periods: targetPeriodsWithProgress
        };
    ...
    <div className="mt-8 mb-4 space-y-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <Link href={`/admin/orders?company_id=${company.id}`} className="bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700 transition">All Orders</Link>
          ...
          <Link href={`/admin/companies/${company.id}/historical-sales`} className="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition">Historical Sales</Link>
