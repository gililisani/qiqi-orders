    ...
    <AdminLayoutWrapper routes={adminRoutes}>
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/admin/payment-terms" className="text-gray-600 hover:text-gray-800">← Back</Link>
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/admin/payment-terms" className="bg-gray-300 text-gray-700 px-6 py-2 rounded hover:bg-gray-400 transition">Cancel</Link>
          </div>
        </form>
      </div>
    </AdminLayoutWrapper>
