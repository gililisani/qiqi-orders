    ...
    (async () => {
      try {
        ...
        setFormData({
          ...
          salon_price: d.salon_price?.toString() || '',
          msrp: d.msrp?.toString() || '',
    ...
    try {
      const { error: updateError } = await supabase
        ...
        .update({
          ...
          salon_price: formData.salon_price.trim() ? parseFloat(formData.salon_price) : null,
          msrp: formData.msrp.trim() ? parseFloat(formData.msrp) : null,
