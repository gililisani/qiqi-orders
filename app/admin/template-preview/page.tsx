  ...
  return (
    <AdminLayoutWrapper routes={adminRoutes}>
      <div className="tw-mt-8 tw-mb-4">
        <Typography variant="h2" color="blue-gray" className="tw-mb-6" {...defaultProps}>
          Template Preview
        </Typography>
        <Typography variant="lead" color="gray" className="tw-mb-8" {...defaultProps}>
        ...
        <div className="tw-grid tw-grid-cols-1 tw-gap-6 md:tw-grid-cols-2 lg:tw-grid-cols-3">
          {/* Sample Card 1 */}
          <Card className="tw-border tw-border-blue-gray-100 tw-shadow-sm" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            <CardHeader
              floated={false}
              variant="gradient"
              color="blue"
              ...
              onPointerLeaveCapture={undefined}
            >
              <Typography variant="h6" color="white" className="tw-font-medium" {...defaultProps}>
                Total Orders
              </Typography>
            ...
            <CardBody placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
              <Typography variant="small" color="gray" className="tw-font-medium" {...defaultProps}>
        ...
        {/* Notice Card */}
        <Card className="tw-mt-6 tw-border tw-border-blue-200 tw-bg-blue-50" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          <CardBody placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            <Typography variant="h6" color="blue-gray" className="tw-mb-2" {...defaultProps}>
              🎨 Design Preview Mode
            </Typography>
