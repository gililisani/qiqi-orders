      ...
      `}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className={`flex items-center space-x-3 ${isCollapsed ? 'justify-center' : ''}`}>
            <Link href="/admin" className="flex items-center space-x-2 hover:opacity-90 transition">
              <Image src="/logo.png" alt="Qiqi Logo" width={32} height={16} className="flex-shrink-0" />
              {!isCollapsed && (
                <span className="text-lg font-semibold text-gray-900">Partners Hub</span>
              )}
            </Link>
          </div>
          <button
        ...
        <div className="border-t border-gray-200 p-4">
          <Link
            href="/admin/admins"
            className={`
              flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors text-gray-700 hover:bg-gray-50 hover:text-gray-900
              ${isCollapsed ? 'justify-center' : ''}
            `}
