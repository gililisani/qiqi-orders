                  ...
                  return (
                    <>
                      ...
                      {allProducts.map((product, index) => {
                        const qty = typeof product.total_quantity === 'number' && !Number.isNaN(product.total_quantity)
                          ? product.total_quantity
                          : 0;
                        const weight = typeof product.total_weight === 'number' && !Number.isNaN(product.total_weight)
                          ? product.total_weight
                          : 0;
                        const totalValue = typeof product.total_value === 'number' && !Number.isNaN(product.total_value)
                          ? product.total_value
                          : 0;
                        ...
                        return (
                          <Row key={`${product.hs_code}-${index}`} top={0.5}>
                            ...
                            <Cell width={widths[2]} align="center">{qty.toLocaleString('en-US')}</Cell>
                            <Cell width={widths[3]} align="center">Each</Cell>
                            <Cell width={widths[4]} align="center">{weight.toFixed(2)} kg</Cell>
                            <Cell width={widths[5]} align="center">EAR99</Cell>
                            <Cell width={widths[6]} align="center"></Cell>
                            <Cell width={widths[7]}>NLR</Cell>
                            <Cell width={widths[8]} align="center">{formatCurrency(totalValue)}</Cell>
