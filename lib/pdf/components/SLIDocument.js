    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        <View style={styles.table}>
          ...
          {/* Insurance/Payment Section - 4 rows total */}
          {/* Box 25 label spans rows 1-2, checkboxes in rows 3-4 */}
          
          {/* Row 1: Box 21 + checkboxes | Box 25 label (height=30 to span 2 rows) */}
          <View style={{ flexDirection: 'row', minHeight: 15, borderBottomWidth: 0.5, borderBottomColor: '#000', borderBottomStyle: 'solid' }}>
            <View style={[styles.labelCell, { width: '25%', borderBottomWidth: 0 }]}><Text>21. Shipper Requests Insurance:</Text></View>
            <View style={[styles.cell, { width: '20%', flexDirection: 'row', borderBottomWidth: 0 }]}>
              <CB checked={cs.insurance_yes} label="Yes" />
              <CB checked={cs.insurance_no} label="No" />
            </View>
            <View style={[styles.labelCellNoRight, { width: '55%', height: 30, justifyContent: 'center', alignItems: 'center', borderBottomWidth: 0 }]}>
              <Text>25. SHIPPER'S INSTRUCTION in case of inability to deliver consignment as consigned.</Text>
            </View>
          </View>
          
          {/* Row 2: Box 22 | Box 25 continues (blank space) */}
          <View style={{ flexDirection: 'row', minHeight: 15, borderBottomWidth: 0.5, borderBottomColor: '#000', borderBottomStyle: 'solid' }}>
            <View style={[styles.labelCell, { width: '25%', borderBottomWidth: 0 }]}><Text>22. Declared Value for Cartage:</Text></View>
            <View style={[styles.cellNoRight, { width: '20%', borderBottomWidth: 0 }]}><Text style={styles.text}></Text></View>
          </View>
          
          {/* Row 3: Box 23 + checkboxes | Abandoned + Return to Shipper */}
          <View style={{ flexDirection: 'row', minHeight: 15, borderBottomWidth: 0.5, borderBottomColor: '#000', borderBottomStyle: 'solid' }}>
            <View style={[styles.labelCell, { width: '25%', borderBottomWidth: 0 }]}><Text>23. Shipper Must Check:</Text></View>
            <View style={[styles.cell, { width: '20%', flexDirection: 'row', borderBottomWidth: 0 }]}>
              <CB checked={cs.payment_prepaid} label="Prepaid" />
              <CB checked={cs.payment_collect} label="Collect" />
            </View>
            <View style={[styles.cell, { width: '27.5%', flexDirection: 'row', borderBottomWidth: 0 }]}><CB checked={cs.abandoned} label="Abandoned" /></View>
            <View style={[styles.cellNoRight, { width: '27.5%', flexDirection: 'row', borderBottomWidth: 0 }]}><CB checked={cs.return_to_shipper} label="Return to Shipper" /></View>
          </View>
          
          {/* Row 4: Box 24 | Deliver To checkbox */}
          <View style={{ flexDirection: 'row', minHeight: 15, borderBottomWidth: 0.5, borderBottomColor: '#000', borderBottomStyle: 'solid' }}>
            <View style={[styles.labelCell, { width: '25%', borderBottomWidth: 0 }]}><Text>24. C.O.D Amount:</Text></View>
            <View style={[styles.cell, { width: '20%', borderBottomWidth: 0 }]}><Text style={styles.text}>$</Text></View>
            <View style={[styles.cellNoRight, { width: '55%', flexDirection: 'row', borderBottomWidth: 0 }]}><CB checked={cs.deliver_to} label="Deliver To:" /></View>
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.cellNoRight, { width: '97%', flexDirection: 'row', justifyContent: 'flex-start' }]}>
