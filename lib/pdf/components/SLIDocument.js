...
export const SLIDocument = ({ data }) => {
  ...
  const products = Array.from(aggregatedMap.values());
  
  console.log('Raw products:', rawProducts.length);
  console.log('Aggregated products:', products.length);
      ...
      <Page size="LETTER" style={styles.page}>
        <View style={styles.table}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.cellNoRight, { width: '20%' }]}><Text style={styles.text}>{data.date_of_export || ''}</Text></View>
          </View>
          ...
          {/* Insurance/Payment Section - 4 rows, box 25 spans rows 1-2 */}
          {/* Row 1: Box 21, Yes/No, Box 25 label (starts here, spans 2 rows) */}
          <View style={styles.row}>
            ...
            <View style={[styles.labelCellNoRight, { width: '55%', justifyContent: 'center', alignItems: 'center' }]}>
              <Text>25. SHIPPER'S INSTRUCTION in case of inability to deliver consignment as consigned.</Text>
            </View>
          </View>
          
          {/* Row 2: Box 22, empty cell, box 25 continues (same 55% area) */}
          <View style={styles.row}>
            ...
            <View style={[styles.cellNoRight, { width: '55%', backgroundColor: '#def0fd' }]}><Text style={styles.text}></Text></View>
          </View>
          ...
          <View style={[styles.row, { flex: 1, minHeight: 30 }]}>
            <View style={[styles.cellNoRight, { width: '100%' }]}>
          ...
          {products.map((product, index) => (
            <View key={index} style={styles.row}>
              <View style={[styles.cell, { width: '8%' }]}><Text style={styles.text}>30</Text></View>
              <View style={[styles.cell, { width: '16%' }]}><Text style={styles.text}>{product.hs_code || 'N/A'}</Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}>{product.quantity} Each</Text></View>
              <View style={[styles.cell, { width: '11%' }]}><Text style={styles.text}></Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}>{product.weight.toFixed(2)} kg</Text></View>
              ...
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}>${product.value.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</Text></View>
          ...
          <View style={[styles.row, { height: 24 }]}>
            ...
            <View style={[styles.cell, { width: '30%', position: 'relative' }]}>
              <Image src="/templates/Sig.png" style={{ position: 'absolute', height: 24, left: 0, top: 0 }} />
            </View>
