    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        <View style={styles.table}>
          ...
          {/* Combined Row 1+2: Using absolute positioning to simulate rowspan */}
          <View style={{ position: 'relative' }}>
            ...
            <View style={styles.row}>
              ...
              <View style={[styles.labelCellNoRight, { width: '55%', height: 24, justifyContent: 'center', alignItems: 'center', position: 'absolute', right: 0, top: 0 }]}>
