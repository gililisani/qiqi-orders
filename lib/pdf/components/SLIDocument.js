...
// Replace your CB with this:
const CB = ({ checked, label }) => (
  <View style={styles.checkboxContainer}>
    <View style={styles.checkbox}>
      {checked ? (
        <Svg width={8} height={8}>
          {/* inset the lines slightly so they don't collide with the box border */}
          <Line x1={1} y1={1} x2={7} y2={7} stroke="#000" strokeWidth={0.8} />
          <Line x1={7} y1={1} x2={1} y2={7} stroke="#000" strokeWidth={0.8} />
        </Svg>
      ) : null}
    </View>
