    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Table border={0.5} style={{ width: LETTER.live.width }}>
          ...
          <Tr bottom={0.5}>
            <Td right={0} pad={0} style={{ paddingBottom: 0 }}>
              <Table border={0.5} style={{ width: LETTER.live.width }}>
                <Tr top={0.5} bottom={0.5}>
                  <Td width={COL_W.c27} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>27. D/F</Text>
                  </Td>
                  <Td width={COL_W.c28desc} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>28. Schedule B / HTS Commercial Commodity Desc</Text>
                  </Td>
                  <Td width={COL_W.c28qty} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>28. SchB/HTS QTY / UOM (if applicable)</Text>
                  </Td>
                  <Td width={COL_W.c30} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>30. DDTC Quantity and DDTC Unit of Measure</Text>
                  </Td>
                  <Td width={COL_W.c31} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>31. Shipping Weight (in Kilos)</Text>
                  </Td>
                  <Td width={COL_W.c32} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>32. ECCN EAR99 or USML Category #</Text>
                  </Td>
                  <Td width={COL_W.c33} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>33. S M E (Y/N)</Text>
                  </Td>
                  <Td width={COL_W.c34} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>34. NLR, Export License No, License Exception Symbol, DDTC Exemption No, DDTC ACM No.,</Text>
                  </Td>
                  <Td width={COL_W.c35} bg="#def0fd" right={0.5} align="center" valign="middle">
                    <Text style={styles.textBold}>35. Value at the Port of Export (US Dollars)</Text>
                  </Td>
                  <Td width={COL_W.c36} bg="#def0fd" right={0} align="center" valign="middle">
                ...
                {allProducts.map((product, index) => (
                  <Tr key={index} bottom={index === allProducts.length - 1 ? 0 : 0.5}>
                    <Td width={COL_W.c27} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}>{getDorF(product.made_in)}</Text>
                    </Td>
                    <Td width={COL_W.c28desc} right={0.5} valign="middle">
                      <Text style={styles.text}>{product.hs_code}</Text>
                    </Td>
                    <Td width={COL_W.c28qty} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}>{product.total_quantity.toLocaleString('en-US')}</Text>
                    </Td>
                    <Td width={COL_W.c30} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}>Each</Text>
                    </Td>
                    <Td width={COL_W.c31} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}>{product.total_weight.toFixed(2)} kg</Text>
                    </Td>
                    <Td width={COL_W.c32} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}>EAR99</Text>
                    </Td>
                    <Td width={COL_W.c33} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}></Text>
                    </Td>
                    <Td width={COL_W.c34} right={0.5} valign="middle">
                      <Text style={styles.text}>NLR</Text>
                    </Td>
                    <Td width={COL_W.c35} right={0.5} valign="middle" align="center">
                      <Text style={styles.text}>${product.total_value.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</Text>
                    </Td>
                    <Td width={COL_W.c36} right={0} valign="middle" align="center">
                      <Text style={styles.text}></Text>
                    </Td>
                  </Tr>
                ))}
