                    ...
                    <>
                      <Row>
                        ...
                        <Cell width={col55} bg="#def0fd" justify="flex-start" pad={4} rightBorder={false}>
                          <Text style={styles.textBold}>25. !!'S INSTRUCTION in case of inability to deliver consignment as consigned.</Text>
                    ...
                    <>
                      ...
                      {allProducts.map((product, index) => (
                        <Row key={`${product.hs_code}-${index}`} top={0.5}>
                          ...
                          <Cell width={widths[4]} align="center">{Number(product.total_weight ?? product.weight ?? 0).toFixed(2)} kg</Cell>
