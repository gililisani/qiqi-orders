...
{/* Row 6: Insurance / Payment & Box 25 (rowspan via placeholder) */}
<Row top={0.5}>
  <Cell width={LETTER.live.width} borders={makeBorder(0, 0, 0, 0)} pad={0}>
    <View>
      {(() => {
        ...
        const wRight = pct(55);        // merged cell width

        const widths4 = [pct(25), pct(20), pct(25), pct(30)];

        return (
          <>
            {/* ROW A: left row 1 + right merged cell (top half of rowspan) */}
            <Row>
              {/* Left row 1 */}
              ...
              {/* Right merged cell (spans 2 rows) */}
              <Cell width={wRight} justify="flex-start" pad={4} rightBorder={false}>
            ...
            {/* ROW B: left row 2 + EMPTY placeholder on right (bottom half of rowspan) */}
            <Row top={0.5}>
              {/* Left row 2 */}
              <Cell width={col25} bg="#def0fd">
              ...
              {/* Placeholder keeps the grid aligned; no height, no borders */}
              <Cell
                width={wRight}
                borders={makeBorder(0, 0, 0, 0)}
            ...
            <Row top={0.5}>
              ...
              <Cell width={widths4[2] + widths4[3]} rightBorder={false}>
