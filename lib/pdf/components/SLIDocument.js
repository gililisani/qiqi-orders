                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <Row top={0.5}>
                        <Cell width={col30}>{data.usppi_name || 'Qiqi INC'}</Cell>
                        <Cell width={col30}>{data.freight_location_name || 'PACKABLE / Webb Enterprises'}</Cell>
                      ...
                      <Row top={0.5}>
                        <Cell width={col30}>{data.usppi_address_line1 || '4625 West Nevso Drive, Suite 2'}</Cell>
                        <Cell width={col30}>{data.freight_location_address_line1 || '1516 Motor Parkway'}</Cell>
                        <Cell width={col40} rightBorder={false}>{data.forwarding_agent_line3 || ''}</Cell>
                      </Row>
                      <Row top={0.5}>
                        <Cell width={col30}>{data.usppi_address_line2 || 'Las Vegas, NV 89103'}</Cell>
                        <Cell width={col30}>{data.freight_location_address_line2 || 'Islandia, New York, 11749'}</Cell>
                        <Cell width={col40} rightBorder={false}>{data.forwarding_agent_line4 || ''}</Cell>
                      </Row>
                      <Row top={0.5}>
                        <Cell width={col30} borders={makeBorder(0, 0.5, 0, 0)}>{data.usppi_country || 'United States'}</Cell>
                        <Cell width={col30} borders={makeBorder(0, 0.5, 0, 0)}>{data.freight_location_country || 'United States'}</Cell>
                  ...
                  return (
                    <>
                      <Row>
                        ...
                        <Cell width={widths[1]}>{data.usppi_ein || '86-2244756'}</Cell>
