...
const t = StyleSheet.create({
  ...
  cell: { display: 'table-cell', verticalAlign: 'middle' },
  text: { fontSize: 7.5 },
});
    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        <Table border={0.5} style={{ width: LETTER.live.width }}>
          {/* Row 1: Title */}
          <Tr bottom={0.5}>
            <Td right={0} pad={4} style={{ height: 40 }} align="center" valign="middle">
            ...
            <Td right={0} pad={0}>
              <Table border={0}>
                <Tr bottom={0.5}>
                  ...
                  <Td width="20%" right={0.5}>{data.state_of_origin || 'NY'}</Td>
          ...
          {/* Row 6: Insurance / Payment & Instructions */}
          <Tr bottom={0.5}>
            <Td right={0} pad={0}>
              <Table border={0}>
                <Tr bottom={0}>
                  <Td width="45%" right={0.5} pad={0}>
                    <Table border={0}>
                      <Tr bottom={0.5}>
                        <Td width="55%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>21. Shipper Requests Insurance:</Text></Td>
                        <Td width="45%" right={0}><CB checked={cs.insurance_yes} label="Yes" /><CB checked={cs.insurance_no} label="No" /></Td>
                      </Tr>
                      <Tr bottom={0.5}>
                        <Td width="55%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>22. Declared Value for Cartage:</Text></Td>
                        <Td width="45%" right={0}>{formatCurrency(data.declared_value_cartage)}</Td>
                      </Tr>
                      <Tr bottom={0.5}>
                        <Td width="55%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>23. Shipper Must Check:</Text></Td>
                        <Td width="45%" right={0}>
                      ...
                      <Tr bottom={0}>
                        <Td width="55%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>24. C.O.D Amount:</Text></Td>
                        <Td width="45%" right={0}>
                          <Text style={styles.text}>{formatCurrency(data.cod_amount)}</Text>
                          <Table border={0}>
                            <Tr bottom={0}>
                  ...
                  <Td width="55%" right={0} bg="#def0fd" valign="top" pad={4}>
          ...
          <Tr bottom={0.5}>
            <Td right={0} pad={0}>
              <Table border={0.5}>
                <Tr bottom={0.5}>
                  <Td width="8%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>27. D/F</Text></Td>
                  <Td width="18%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>28. Schedule B / HTS Commercial Commodity Desc</Text></Td>
                  <Td width="10%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>28. SchB/HTS QTY / UOM (if applicable)</Text></Td>
                  <Td width="12%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>30. DDTC Quantity and DDTC Unit of Measure</Text></Td>
                  <Td width="10%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>31. Shipping Weight (in Kilos)</Text></Td>
                  <Td width="10%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>32. ECCN EAR99 or USML Category #</Text></Td>
                  <Td width="8%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>33. S M E (Y/N)</Text></Td>
                  ...
                  <Td width="12%" bg="#def0fd" right={0.5} align="center"><Text style={styles.textBold}>35. Value at the Port of Export (US Dollars)</Text></Td>
                  <Td width="10%" bg="#def0fd" right={0} align="center"><Text style={styles.textBold}>36. License Value by item (if applicable) (US Dollars)</Text></Td>
                </Tr>
                {allProducts.map((product, index) => (
                  <Tr key={`${product.hs_code}-${index}`} bottom={index === allProducts.length - 1 ? 0 : 0.5}>
                    <Td width="8%" right={0.5} align="center">{getDorF(product.made_in)}</Td>
                    <Td width="18%" right={0.5}>{product.hs_code}</Td>
                    <Td width="10%" right={0.5} align="center">{product.total_quantity.toLocaleString('en-US')} Each</Td>
                    <Td width="12%" right={0.5} align="center">Each</Td>
                    <Td width="10%" right={0.5} align="center">{product.total_weight.toFixed(2)} kg</Td>
                    <Td width="10%" right={0.5} align="center">EAR99</Td>
                    <Td width="8%" right={0.5} align="center"></Td>
                    <Td width="12%" right={0.5}>NLR</Td>
                    <Td width="12%" right={0.5} align="center">{formatCurrency(product.total_value)}</Td>
                    <Td width="10%" right={0} align="center"></Td>
                  </Tr>
                ))}
              </Table>
            </Td>
            ...
            <Td right={0} pad={0}>
              <Table border={0}>
                <Tr bottom={0}>
                  ...
                  <Td width="20%" right={0.5}>{data.ddtc_registration || ''}</Td>
            ...
            <Td right={0} pad={0}>
              <Table border={0}>
                <Tr bottom={0}>
                  ...
                  <Td width="25%" right={0.5}>{data.usppi_email || 'aaron@qiqiglobal.com'}</Td>
                  <Td width="30%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>43. USPPI Telephone No.:</Text></Td>
                  <Td width="20%" right={0}>{data.usppi_phone || '00972-54-6248884'}</Td>
                </Tr>
              </Table>
            </Td>
          </Tr>
            ...
            <Td right={0} pad={0}>
              <Table border={0}>
                <Tr bottom={0}>
                  ...
                  <Td width="50%" right={0}>{data.printed_name || 'Aaron Lisani'}</Td>
                </Tr>
              </Table>
            </Td>
          </Tr>
            ...
            <Td right={0} pad={0}>
              <Table border={0}>
                <Tr bottom={0}>
                  ...
                  <Td width="30%" right={0.5} style={styles.signatureWrapper}>
                    <Image
                      src={data.signature_url || '/templates/Sig.png'}
                      style={styles.signatureImage}
                    />
                  </Td>
                  <Td width="15%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>46. Title:</Text></Td>
                  <Td width="15%" right={0.5}>{data.signer_title || 'CPO'}</Td>
                  <Td width="10%" bg="#def0fd" right={0.5}><Text style={styles.textBold}>47. Date:</Text></Td>
                  <Td width="15%" right={0}>{data.sli_date || new Date().toLocaleDateString('en-US')}</Td>
                </Tr>
              </Table>
            </Td>
          </Tr>
