      ...
      <Page size="LETTER" style={styles.page}>
        <View style={styles.table}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.cell, { width: '30%' }]}><Text style={styles.text}>United States</Text></View>
            <View style={[styles.cellNoRight, { width: '40%', flexDirection: 'row' }]}>
              <View style={[styles.labelCell, { width: '50%' }]}><Text>6. Date of Export:</Text></View>
              <View style={[styles.cellNoRight, { width: '50%' }]}><Text style={styles.text}>{data.date_of_export || ''}</Text></View>
            </View>
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.labelCellNoRight, { width: '55%', height: 24, justifyContent: 'center' }]}>
              <Text>25. SHIPPER'S INSTRUCTION in case of inability to deliver consignment as consigned.</Text>
            </View>
          </View>
          
          {/* Insurance/Payment Row 2 */}
          <View style={styles.row}>
          ...
          {products.map((product, index) => (
            <View key={index} style={styles.row}>
              ...
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}>{product.quantity} PCS</Text></View>
              <View style={[styles.cell, { width: '11%' }]}><Text style={styles.text}></Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}>{product.weight.toFixed(2)}</Text></View>
              ...
              <View style={[styles.cell, { width: '11%' }]}><Text style={styles.text}></Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}>${product.value.toFixed(2)}</Text></View>
              <View style={[styles.cellNoRight, { width: '7%' }]}><Text style={styles.text}></Text></View>
            </View>
          ))}

          {/* Empty product rows to fill minimum 6 rows */}
          {Array.from({ length: Math.max(0, 6 - products.length) }).map((_, i) => (
            <View key={`empty-${i}`} style={styles.row}>
              <View style={[styles.cell, { width: '8%' }]}><Text style={styles.text}> </Text></View>
              <View style={[styles.cell, { width: '16%' }]}><Text style={styles.text}> </Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}> </Text></View>
              <View style={[styles.cell, { width: '11%' }]}><Text style={styles.text}> </Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}> </Text></View>
              <View style={[styles.cell, { width: '10%' }]}><Text style={styles.text}> </Text></View>
              <View style={[styles.cell, { width: '7%' }]}><Text style={styles.text}> </Text></View>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.cell, { width: '30%', justifyContent: 'center' }]}>
